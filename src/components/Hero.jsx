    ...
    <div >
      ...
      <div className="absolute  top-[120px]  left-[50px]  flex flex-col gap-2">
        ...
        <div className="flex justify-center text-center text-white">
          <p className="bg-orange-900 px-8 text-5xl py-4">16</p>
          <p className="bg-orange-400 text-5xl px-8 py-4">20</p>
        </div>
        ...
        <div className="flex gap-24 my-12  justify-center text-center">
          ...
          <p className="bg-purple-500 text-md px-8 py-2 text-xl bg-orange-900 rounded-[50px] text-white">
            Purhase
          </p>
        </div>
      </div>
      <div className="absolute top-[70px]  uppercase text-white right-[10px]">
        ...
        >
          Seals
              ...
              <p className="mt-24 text-center text-5xl italic">
                  D . Wabwire
