...
const Ticket = () => {
  return (
    <>
      ...
      <div className="w-[90%] my-8 p-4 mx-auto border-t-8 border-yellow-200 bg-gray-100 text-3xl font-bold flex justify-between">
        <div className="flex">
        ...
        <h1 className="text-red-500 flex text-5xl items-center">SOLD OUT</h1>
      ...
      <div className="flex justify-between bg-gray-100 mx-auto w-[90%] my-12 p-4">
